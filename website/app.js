...
function performAction(e) {
  ...
  getCityWeather(baseURL, zipCode, apiKey)
    .then(function (data) {
      console.log("Data passed to Postdata function");
      postData("/addlog", {
        temp: data.main.temp,
        date: newDate,
        content: feelings,
...
const Debugging = () => {
  console.log("Debug happens here");
};
...
const getCityWeather = async (baseURL, cityCode, Key) => {
  ...
  try {
    ...
    console.log("Data fetched from openweather API:", data);
    return data;
  } catch (error) {
    console.log("error", error);
  }
...
const updateUI = async () => {
  ...
  try {
    ...
    console.log("Data get from Server", allData);
